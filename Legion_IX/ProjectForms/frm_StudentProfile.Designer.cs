...
namespace Legion_IX
{
    partial class frm_StudentProfile
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frm_StudentProfile));
            button_LogOut = new Button();
            btn_Documents = new Button();
            txtBox_NetworkStatus = new TextBox();
            studentData1 = new StudentData();
            studentDocuments1 = new StudentDocuments();
            btn_Profile = new Button();
            btn_ProfileSettings = new Button();
            studentProfileSettings1 = new StudentProfileSettings();
            studentDownloadedDocs1 = new StudentDownloadedDocs();
            ...
            // 
            // studentDownloadedDocs1
            // 
            studentDownloadedDocs1.BackColor = Color.Transparent;
            studentDownloadedDocs1.BorderStyle = BorderStyle.FixedSingle;
            studentDownloadedDocs1.Location = new Point(0, 0);
            studentDownloadedDocs1.Name = "studentDownloadedDocs1";
            studentDownloadedDocs1.Size = new Size(652, 468);
            studentDownloadedDocs1.TabIndex = 0;
            // 
            // btn_DownloadedDocs
            // 
        ...
        private User_Controls.StudentDownloadedDocs studentDownloadedDocs1;
    }
}